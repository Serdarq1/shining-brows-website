...
import OperationTemplateHero from '@/components/OperationTemplateHero';
...
export default function OperationView({ slug, trainers = [] }) {
  ...
  return (
    <>
      ...
      <main>
        ...
        <OperationTemplateHero locale={locale} slug={slug} />
